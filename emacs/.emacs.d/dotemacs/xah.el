...
in `xah-brackets'.  This command ignores nesting. For example, if
text is
    (a(b)c▮)
...
(defun xah-select-line ()
  "Select current line. If region is active, extend selection
downward by line.
...
(defun xah-extend-selection ()
  "Select the current word, bracket/quote expression, or expand
selection. Subsequent calls expands the selection.
...
still experimental. But when cursor is on a any type of
